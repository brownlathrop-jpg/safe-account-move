 ...
 * Печатается на книжном листе А4: ордер сверху, отрезная квитанция — снизу.
 */
export function Pko({
  org,
  number,
  ...
  return (
    <div className="text-black" style={{ fontSize: 10, lineHeight: 1.25 }}>
      {/* ==================== ОРДЕР ==================== */}
      <div>
        ...
        <table className="mt-1 w-full border-collapse">
          <tbody>
            ...
            <tr>
              <td className="align-bottom pt-1" colSpan={2}>
        ...
        <div className="mt-2 text-center font-bold" style={{ fontSize: 12 }}>ПРИХОДНЫЙ КАССОВЫЙ ОРДЕР</div>
      ...
      {/* ==================== КВИТАНЦИЯ ==================== */}
      <div>
        <div className="text-center font-bold" style={{ fontSize: 11 }}>КВИТАНЦИЯ</div>
        <div className="mt-1 flex items-end gap-1">
        ...
        <div className="mt-2">«____» _______________ {safeDate.getFullYear()} г.</div>
        <div className="mt-2 text-center" style={{ fontSize: 8 }}>М.П. (штампа)</div>
        <div className="mt-3 flex items-end gap-2">
          <span>Главный бухгалтер</span>
          <Field className="flex-1" caption="подпись" />
        </div>
